...
function getCountryCentroid(iso){
  ...
  if(!feat)return null;
  const proj=d3.geoMercator().center([18,50]).scale(document.getElementById("mapChart").clientWidth*0.88).translate([document.getElementById("mapChart").clientWidth/2,310]);
